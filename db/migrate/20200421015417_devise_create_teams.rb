...
class DeviseCreateTeams < ActiveRecord::Migration[6.0]
  def change
    create_table :teams do |t|
      ...
      t.string :name, null: false, length: 30, unique: true
      t.string :representative, null: false, length: 20
      t.string :homepage, length: 100
      t.string :location, null: false, length: 30
      t.text :introduction, null: false, length: 100
